...
plugins {
    ...
    id("org.jetbrains.dokka-javadoc") version "2.2.0"   // https://kotlinlang.org/docs/dokka-get-started.html
    ...
    id("maven-publish")                                 // https://docs.gradle.org/8.14.4/userguide/publishing_maven.html
    id("java-library")                                  // https://docs.gradle.org/8.14.4/userguide/java_library_plugin.html
    id("signing")                                       // https://docs.gradle.org/8.14.4/userguide/signing_plugin.html
    id("jacoco")                                        // https://docs.gradle.org/8.14.4/userguide/jacoco_plugin.html
}
...
repo?.run { // tasks for publishing on maven repo
    ...
    // configure task javadocJar to take javadoc generated by dokka
